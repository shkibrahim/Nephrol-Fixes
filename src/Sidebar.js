...
import {StyleSheet, Button, TextInput, View, Text, Keyboard, Alert, Modal, Image, TouchableOpacity,} from 'react-native';
    ...
    return (
        <View style={{ flex: 1, backgroundColor: "#F5F5F5" }}>
            <View style={{
                ...
                <Image source={require('../Images/Profile.jpg')} style={{ width: 120, height: 120, borderRadius: 80 }} />
                <Text style={{ fontWeight: "bold", fontSize: 25, top: 10, color: "#1A1A1A" }}>Muhammad Ali</Text>
                <Text style={{ fontWeight: "bold", fontSize: 18, top: 10, color: "#5C5C5C" }}>Patient</Text>
            </View>
